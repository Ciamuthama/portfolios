...
export default function NavAgency() {
  return (
    <div className="flex justify-between items-center shadow bottom-2 left-0 right-0 sticky w-[22rem]  py-3 px-2 mx-auto text-[#004030] bg-[#e1c6b5]/70 backdrop-blur-xl rounded-2xl">
      <Link
        href="/"
